...
namespace Book_Store_MVC.Migrations
{
    ...
    [Migration("20240812202606_intiInlocal")]
    partial class intiInlocal
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Book_Store_MVC.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 1,
                            OrderDate = new DateTime(2024, 8, 12, 23, 26, 3, 921, DateTimeKind.Local).AddTicks(8534)
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = 2,
                            OrderDate = new DateTime(2024, 8, 12, 23, 26, 3, 921, DateTimeKind.Local).AddTicks(8652)
                        });
                });
