...
namespace Book_Store_MVC.Migrations
{
    ...
    [Migration("20240808160650_Adding_identity_Account")]
    partial class Adding_identity_Account
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Book_Store_MVC.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 1,
                            OrderDate = new DateTime(2024, 8, 8, 19, 6, 49, 824, DateTimeKind.Local).AddTicks(4893)
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = 2,
                            OrderDate = new DateTime(2024, 8, 8, 19, 6, 49, 824, DateTimeKind.Local).AddTicks(4951)
                        });
                });
