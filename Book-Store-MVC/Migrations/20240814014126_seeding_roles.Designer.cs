...
namespace Book_Store_MVC.Migrations
{
    ...
    [Migration("20240814014126_seeding_roles")]
            ...
            modelBuilder.Entity("Book_Store_MVC.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 1,
                            OrderDate = new DateTime(2024, 8, 14, 4, 41, 23, 626, DateTimeKind.Local).AddTicks(848)
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = 2,
                            OrderDate = new DateTime(2024, 8, 14, 4, 41, 23, 626, DateTimeKind.Local).AddTicks(917)
                        });
                });
