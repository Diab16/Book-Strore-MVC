...
namespace Book_Store_MVC.Migrations
{
    ...
    [Migration("20240808124124_InitialCreate")]
            ...
            modelBuilder.Entity("Book_Store_MVC.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 1,
                            OrderDate = new DateTime(2024, 8, 8, 15, 41, 21, 723, DateTimeKind.Local).AddTicks(2173)
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = 2,
                            OrderDate = new DateTime(2024, 8, 8, 15, 41, 21, 723, DateTimeKind.Local).AddTicks(2221)
                        });
                });
